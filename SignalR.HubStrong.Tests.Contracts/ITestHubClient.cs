namespace SignalR.HubStrong.Tests.Contracts
{
    ...
    public interface ITestHubClient
    {
        ...
        void MultipleParamTypes(int intParam, long longParam, bool boolParam, string stringParam, string[] arrayParam, Dictionary<string, int> dictionaryParam, Foo objectParam1);
    }
}
